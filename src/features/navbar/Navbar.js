              ...
              <div className="hidden md:block">
                <div className="ml-4 flex items-center md:ml-6">
                  ...
                  >
                    ...
                    {items.length &&<span className="inline-flex items-center rounded-3xl bg-red-50 px-2 py-1 text-xs font-medium mb-6 -ml-4 z-30   text-red-500 ring-1 ring-inset ring-red-600/10">{items.length}</span>}
